      ...
      <main className="flex-1">
        <section className="relative overflow-hidden min-h-[85vh] flex items-center justify-center bg-background">
          <div className="absolute inset-0 z-0">
            <img src="https://images.unsplash.com/photo-1498804103079-a6351b050096?ixlib=rb-4.0.3&auto=format&fit=crop&w=1600&q=80" alt="Coffee hills" className="w-full h-full object-cover opacity-20 dark:opacity-10" />
          ...
          <div className="max-w-7xl mx-auto px-4 py-32 relative z-10 flex flex-col items-center text-center">
            <h1 className="text-6xl md:text-8xl font-serif mb-6 leading-[1.1] text-foreground">
              Experience Rwandan<br/>
              <span className="text-accent italic font-light">Excellence</span>
            </h1>
            <p className="text-lg md:text-xl max-w-2xl text-muted-foreground mb-12 leading-relaxed">
              Hand-picked, artisanal coffee delivered directly to your door from the thousand hills of Rwanda.
            </p>
